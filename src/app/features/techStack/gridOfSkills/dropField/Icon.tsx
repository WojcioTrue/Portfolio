...
const Icon = ({ dragElement, imgSrc, whiteImgSrc, text }: IconType) => {
  const { constraintDrag, dropTarget, isTarget, isOverTarget, isDragged } =
  ...
  return (
    <motion.div
      ...
      className={`relative z-20 flex h-[55px] w-[55px] cursor-pointer items-center justify-center rounded-lg border-[1px] border-my-purple border-opacity-15 bg-white shadow-myshadow`}
