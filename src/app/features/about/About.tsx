  ...
  return (
    <CarouselContextProvider>
      <div
        id="About"
        ref={aboutSectionRef}
        className="relative min-h-[calc(100%_-_77px)] border-t-[1px] border-my-lightGray bg-my-black pt-10 pb-16 flex items-center flex-col justify-center overflow-hidden">
        <Header />
        <Description />
        <CarouselWrapper />
      </div>
